...
> without interfering with each other. While running, transactions use data com.iluwatar.serviceadapter.soapdemo.resources without
> acquiring locks on those com.iluwatar.serviceadapter.soapdemo.resources. Before committing, each transaction verifies that no other
